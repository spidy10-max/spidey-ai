...
def print_banner():
    ...
    print("=" * 55)
    print("   🤖 Agent:   agent | plan | tools")
    print("   🕷️ Voice:   spidey beta | v | speakmode")
...
def main():
    ...
    print(f"\n   💡 'agent' = Multi-step tasks | 'spidey beta' = Voice mode\n")
    ...
    while True:
        try:
            ...
            # === AI CHAT (last — if no command matched) ===
            try:
                print()
